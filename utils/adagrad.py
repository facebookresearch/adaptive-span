...
class Adagrad(Optimizer):
    ...
    def __init__(self, params, lr=1e-2, lr_decay=0, weight_decay=0, initial_accumulator_value=0, grad_clip=0):
        if not 0.0 <= lr:
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                if group['grad_clip'] > 0:
                    ...
                    if norm > group['grad_clip']:
                        clr *= group['grad_clip'] / (norm + 1e-10)
